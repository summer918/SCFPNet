...
class Trainer(DefaultTrainer):
    ...
    def build_optimizer(cls, cfg, model):
        ...
        # print()
        # n_parameters_head = sum(p.numel() for p in model.box_predictor.parameters() if p.requires_grad)
        ...
        #     print(name,"999999",param.grad)
        # pl=build_optimizer(cfg, model)
        # print(pl.param_groups)
