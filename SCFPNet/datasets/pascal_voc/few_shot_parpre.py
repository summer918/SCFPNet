...
def generate_seeds(args):
    ...
    for year in [2007, 2012]:
        data_file = "/home/dell/Xiangmin/fct/datasets/pascal_voc/VOC{}/ImageSets/Main/trainval.txt".format(year)
        with open(data_file,"r") as f:
            # print(f)
            # np.loadtxt(f, dtype=np.str_).tolist()
    ...
    for fileid in data:
        ...
        dirname = os.path.join("/home/dell/Xiangmin/fct/datasets/pascal_voc", "VOC{}".format(year))
